...
<html>
	<head>
        ...
        $(document).ready(function(){
        	...
        	$("button[nm='DeleteBlog']").click(function(){
				var p = $(this).attr("blogID");
				$("input[name='deleteBlogID']").val(p);
	...
	<body>
        ...
        <div id="content">
			...
			<form action="DeleteBlog.action" method="post" name="deleteBlogForm" id="deleteBlogForm">
				<input type="hidden" name="deleteBlogID" id="deleteBlogID" value=""/>
			</form>
			<form action="RefreshMyspace.action" method="post" name="myspaceForm" id="myspaceForm">
						...
						<div class="widget-box">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                    	&nbsp;&nbsp;
                                    	<fmt:formatDate value="${user.registertime}" pattern="yyyy年MM月dd日"/>
                                    </td>
                                    <td></td>
                                </tr>
                            </table>
							...
							<table class="table table-bordered table-striped">
	                           ...
	                           <fmt:formatDate value="${blog.newstime}" type="both" pattern="yyyy年MM月dd日  HH时mm分ss秒" />
	                                        ...
	                                        <td>
                                        		...
                                        		<button class="btn btn-danger" nm="DeleteBlog" blogID="${blog.blogID}">
