...
<html>
	...
	<body>
        ...
        <div id="content">
			...
			<form action="RefreshMyfan.action" method="post" name="fanForm" id="fanForm">
								...
								<tbody>
									<c:forEach var="fan" items="${fans}">
	                                    <tr>
	                                    	<td>${fan.nickname}</td>
	                                        <td>
	                           <fmt:formatDate value="${fan.registertime}" type="both" pattern="yyyy年MM月dd日  HH时mm分ss秒" />
	                                        </td>
	                                        <td>
	                                        <button class="btn btn-info" nm="GotoOtherspace" otherID="${fan.userID}">
